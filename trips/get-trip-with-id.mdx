...
The fields returned are the same as those in the data from the Get All Trips Response endpoint, with the exception that it does not return an offset number or an array of trip objects, but just a singular trip object.
