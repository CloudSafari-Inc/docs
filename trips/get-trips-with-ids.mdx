---
title: 'Get Trips With IDs'
api: 'POST https://api3.cloudsafaris.com/v1/trips/get-trips-with-ids'
---
...
<ParamField body="trip_ids" type="number[]">
...
The fields returned are the same as those in the data from the [Get All Trips Response](/trips/get-all-trips#response-body-parameters) endpoint, with the exception that it does not return an offset number.
